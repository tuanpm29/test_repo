...
$(function() {
    ...
    $.fn.isValid = function (formId) {
        ...
        for(key in result.errors) {
            ...
            if ( key.indexOf("addr1") == 0 || key.indexOf("addr2") == 0 ) {
                $('#addr1or2_error_msgs').css({visibility: 'visible'});
    ...
    $.onSlideAfterHandler = function($slideElement, oldIndex, newIndex) {
        ...
        if ( pagenum < 6 ) {
            ...
            $('img#form_status')
                 ...
                 .attr('src','/entry/pc/form023/img/status/' + pagenum + '.png');
    ...
    $('#dialog_content').on('inview', function() {
        ...
        if ( flag == "true" ) {
            ...
            //Prevのリンク内を変更
            $('a.bx-prev').html('<img src="/entry/pc/form023/img/btn_back.png" alt="戻る">');
            $('a.bx-prev').hide();
